...
(function(){
  ...
  // --- 状态指示器 ---
  const _STATUS_LABELS = { connected: 'SSE', reconnecting: '重连中', fallback: '轮询', frozen: '已冻结', disconnected: '断开' };
  ...
  function _initStatusIndicator() {
    ...
    el.title = 'SSE 连接状态';
    el.style.cssText = 'font-size:9px;color:#787b86;cursor:default;user-select:none;margin-left:4px;flex-shrink:0';
    el.textContent = '';
    el.dataset.state = '';
    tb.appendChild(el);
  }
